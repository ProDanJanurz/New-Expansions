...
import com.pro__group.new_expansions.blocks.entity.NewexpStoneKilnBlockEntity;
...
public class NewexpStoneKiln extends AbstractFurnaceBlock {
    public NewexpStoneKiln(AbstractBlock.Settings settings) {
        super(settings);
    }

    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new NewexpStoneKilnBlockEntity(pos, state);
    }

    @Nullable
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(world, type, NewexpBlockEntityType.STONE_KILN);
    }

    protected void openScreen(World world, BlockPos pos, PlayerEntity player) {
        BlockEntity blockEntity = world.getBlockEntity(pos);
        if (blockEntity instanceof NewexpStoneKilnBlockEntity) {

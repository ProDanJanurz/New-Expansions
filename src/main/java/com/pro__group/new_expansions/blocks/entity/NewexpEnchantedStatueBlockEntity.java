...
public class NewexpEnchantedStatueBlockEntity extends BlockEntity{
        ...
        if (!list.isEmpty()) {
            ...
            while(var10.hasNext()) {
                ...
                if (pos.isWithinDistance(playerEntity.getBlockPos(), (double)j)) {
                    playerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.LUCK, 410, 0, true, false));
                    playerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 410, 0, true, false));
                }
            }
    ...
    private static void healFriendlyEntity(World world, BlockPos pos) {
        ...
        if (!list1.isEmpty()) {
            ...
            while(var10.hasNext()) {
                ...
                if (pos.isWithinDistance(ironGolemEntity.getBlockPos(), (double)j)) {
        ...
        if (!list2.isEmpty()) {
            ...
            while(var10.hasNext()) {
                ...
                if (pos.isWithinDistance(snowGolemEntity.getBlockPos(), (double)j)) {
        ...
        if (!list3.isEmpty()) {
            ...
            while(var10.hasNext()) {
                ...
                if (pos.isWithinDistance(villagerEntity.getBlockPos(), (double)j)) {
        ...
        if (!list4.isEmpty()) {
            ...
            while(var10.hasNext()) {
                ...
                if (pos.isWithinDistance(wanderingTraderEntity.getBlockPos(), (double)j)) {
    ...
    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, NewexpEnchantedStatueBlockEntity blockEntity) {
        ...
        if (blockEntity.targetEntity != null) {
            ...
            blockEntity.targetEntity.damage(DamageSource.MAGIC, 3.0F);

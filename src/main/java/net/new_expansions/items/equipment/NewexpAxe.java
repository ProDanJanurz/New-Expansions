...
public class NewexpAxe extends NewexpMiningToolItem {
    public static final Map<Block, Block> STRIPPED_BLOCKS;

    public NewexpAxe(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
    ...
    static {
        STRIPPED_BLOCKS = Maps.newHashMap(ImmutableMap.<Block, Block>builder()

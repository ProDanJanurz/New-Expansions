...
public class NewexpShovel extends NewexpMiningToolItem {
    protected static final Map<Block, BlockState> PATH_STATES;

    public NewexpShovel(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {

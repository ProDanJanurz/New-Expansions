...
public class NewexpCointainer extends BlockWithEntity {
    public static final DirectionProperty FACING;
    public static final BooleanProperty OPEN;

    public NewexpCointainer(Settings settings) {
        super(settings);
    ...
    public static final MapCodec<NewexpCointainer> CODEC = createCodec(NewexpCointainer::new);
    
    public MapCodec<NewexpCointainer> getCodec() {
        return CODEC;
    }

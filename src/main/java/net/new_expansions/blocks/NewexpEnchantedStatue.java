...
import net.new_expansions.blocks.entity.NewexpEnchantedStatueBlockEntity;
...
public class NewexpEnchantedStatue extends BlockWithEntity implements Waterloggable{
 ...
 public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    ...
    public NewexpEnchantedStatue(Settings settings) {
        super(settings);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, NewexpBlockEntityType.ENCHANTED_STATUE, NewexpEnchantedStatueBlockEntity::tick);
    }
    ...
    public static final MapCodec<NewexpEnchantedStatue> CODEC = createCodec(NewexpEnchantedStatue::new);
    
    public MapCodec<NewexpEnchantedStatue> getCodec() {
        return CODEC;
    }
}
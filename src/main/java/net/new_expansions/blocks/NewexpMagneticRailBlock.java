...
public class NewexpMagneticRailBlock extends AbstractRailBlock {
	public static final EnumProperty<RailShape> SHAPE;
	public static final BooleanProperty POWERED;
	
	public NewexpMagneticRailBlock(AbstractBlock.Settings settings) {
		super(true, settings);
	...
	public static final MapCodec<NewexpMagneticRailBlock> CODEC = createCodec(NewexpMagneticRailBlock::new);
	
	public MapCodec<NewexpMagneticRailBlock> getCodec() {
		return CODEC;
	}
